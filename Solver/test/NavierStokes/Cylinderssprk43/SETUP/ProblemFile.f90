...
!
            ...
            LOGICAL                            :: success
            integer                            :: rank
            real(kind=RP), parameter           :: cd =  35.519648480544454_RP
            real(kind=RP), parameter           :: cl =  -0.00015980971032764080_RP
            real(kind=RP), parameter           :: wake_u = 3.0133827893341909E-014_RP 
            real(kind=RP), parameter           :: res(5) = [  9.2150026963711227_RP, & 
                                                              24.493033818948572_RP, &
                                                              0.23641974347697386_RP, &
                                                              28.737804952439909_RP, &  
                                                              250.79228731167606_RP] 
#if defined(NAVIERSTOKES)
