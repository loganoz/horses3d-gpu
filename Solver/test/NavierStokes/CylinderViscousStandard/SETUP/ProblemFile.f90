...
!           ---------------
!
            CHARACTER(LEN=29)                  :: testName           = "Cylinder Viscous Standard"
            ...
            LOGICAL                            :: success
            integer                            :: rank, io
            real(kind=RP), parameter :: cd = 39.053957595804242_RP
            real(kind=RP), parameter :: cl = -3.6758798426275163E-003_RP
            real(kind=RP), parameter :: wake_u = 1.3340143990167361E-014_RP
            real(kind=RP), parameter :: res(5) = [  15.134489289399138_RP, &
                                                    38.226316738754406_RP, &
                                                    0.23010462841151258_RP, &
                                                    25.479789477216151_RP, &
                                                    392.42361784786368_RP ]
