...
!        ----------
		 ...
		 if (Samplings % no_of_surfaceSamplings .GT. 0) then
			...
			!$acc update device(Samplings % surfaceSamplings)
		 end if
		 ...
		 if (Samplings % no_of_planeSamplings .GT. 0) then
			...
			!$acc update device(Samplings % planeSamplings)
		 end if
		 ...
		 if (Samplings % no_of_spatialMeanNodes .GT. 0) then
			...
			!$acc update device(Samplings % spatialMeanNodes)
		 end if
