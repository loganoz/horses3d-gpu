...
!           ------------------
         ...
         !$acc enter data copyin(self % active)
         !$acc enter data copyin(self % rank)
         !$acc enter data copyin(self % N)
		 ...
		 !$acc enter data copyin(self % values)
		 !$acc enter data copyin(self % x)
		 !$acc enter data copyin(self % xi)
		 !$acc enter data copyin(self % variable)
...
!               -----------------------------               
                ...
                ELSE
					...
					!$acc update device(self % lxi)
					!$acc update device(self % leta)
					!$acc update device(self % lzeta)
